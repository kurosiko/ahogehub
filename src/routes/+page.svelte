...
<div class="text-center h-screen *:px-5">
    ...
    <section class="bg-gray-800 py-12 mx-5 rounded-xl shadow-lg">
        <h2 class="text-4xl font-bold mb-4 text-pink-400">Join the World of Ahoge</h2>
        <p class="text-lg text-gray-400 mb-8">
            Explore adorable ahoge and join the community today
        </p>
        <a href="get-started" class="inline-block bg-gradient-to-r from-pink-500 to-purple-700 text-white font-bold py-4 px-10 rounded-full transition-transform transform hover:scale-110 hover:shadow-lg">
            Join us now
        </a>
    </section>
</div>